      ...
      <div className="bg-white overflow-hidden">
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center pt-20">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center space-y-6">
            <Reveal>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-emerald-400 text-xs font-bold uppercase tracking-[0.2em] mb-2">
                Our Story
              </div>
              <h1 className="text-5xl md:text-7xl font-semibold text-white tracking-tight leading-[1.1] mb-4" style={{ fontFamily: 'Fraunces, serif' }}>
                Powering the <br />
            ...
            <div className="max-w-3xl mx-auto text-center space-y-6">
              <Reveal delay={200}>
                <div className="space-y-6">
                  ...
                  <h3 className="text-3xl md:text-5xl font-semibold text-[#051428] leading-tight">
                  ...
                  <div className="pt-4 flex justify-center">
                    <div className="flex items-center gap-4 p-6 bg-gray-50 border border-gray-100 rounded-2xl text-left">
                      <div className="w-12 h-12 rounded-xl bg-emerald-600 flex items-center justify-center text-white shrink-0">
                        <Target size={24} />
                      </div>
                      <div>
                        <h4 className="font-semibold text-[#051428]">The Goal</h4>
        ...
        {/* --- Stats Strip --- */}
        <section className="bg-white py-12 relative border-y border-gray-100">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
              {stats.map((stat, i) => (
                <div key={i} className="text-center space-y-2">
                  <div className="w-10 h-10 mx-auto bg-emerald-500/10 rounded-xl flex items-center justify-center text-emerald-600 mb-1">
                    <stat.icon size={20} />
                  </div>
                  <div className="text-4xl font-semibold text-[#051428] tracking-tight">{stat.value}</div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h3 className="text-3xl md:text-5xl font-semibold text-[#051428]">What drives us forward</h3>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
              {values.map((v, i) => (
                <div key={i} className="p-8 bg-white border border-gray-100 rounded-[2rem] hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                  <div className={`w-14 h-14 ${v.bg} ${v.color} rounded-2xl flex items-center justify-center mb-6`}>
                    <v.icon size={28} />
                  </div>
                  <h4 className="text-xl font-semibold text-[#051428] mb-4">{v.title}</h4>
        ...
        <section className="py-20 relative overflow-hidden border-t border-gray-100">
          <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'radial-gradient(circle, #051428 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
          
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center space-y-6">
            <h2 className="text-4xl md:text-6xl font-semibold tracking-tight text-[#051428]" style={{ fontFamily: 'Fraunces, serif' }}>
              Ready to join the <br /> green revolution?
            </h2>
            <p className="text-gray-500 text-lg md:text-xl max-w-xl mx-auto leading-relaxed font-light">
              Start your EV journey with ChargeNet today. Find stations, book slots, and charge effortlessly.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              <button 
                onClick={() => window.location.href = '/signup'}
                className="px-8 py-3.5 bg-emerald-600 text-white font-bold rounded-full hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-900/10"
              >
                Get Started Now
              </button>
              <button 
                onClick={() => window.location.href = '/map'}
                className="px-8 py-3.5 bg-white text-emerald-600 font-bold rounded-full border border-emerald-600 hover:bg-emerald-50 transition-all flex items-center gap-2"
              >
                Explore Stations
                <ArrowRight size={18} />
              </button>
